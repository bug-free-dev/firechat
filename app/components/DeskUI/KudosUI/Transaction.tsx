...
export const KudosTransactionItem: React.FC<KudosTransactionItemProps> = ({
	...
	return (
		<div className="flex items-center justify-between p-3 rounded-xl border border-neutral-300/50 dark:border-neutral-700/40 bg-white dark:bg-neutral-950  transition-all duration-200">
