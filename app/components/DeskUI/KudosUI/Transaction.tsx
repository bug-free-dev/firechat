...
export const KudosTransactionItem: React.FC<KudosTransactionItemProps> = ({
	...
	return (
		<div className="flex items-center justify-between p-3 rounded-lg border border-neutral-200 dark:border-neutral-700/40 bg-white dark:bg-neutral-900  transition-all duration-200">
