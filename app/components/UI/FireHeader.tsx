...
export const FireHeader: React.FC<FireHeaderProps> = ({
  ...
  const sizeClasses = {
    sm: { container: 'mt-3 mb-5', logo: 'w-12 h-12', title: 'text-3xl', subtitle: 'text-xs', icon: 'w-3 h-3' },
    md: { container: 'mt-5 mb-7', logo: 'w-14 h-14', title: 'text-4xl', subtitle: 'text-sm', icon: 'w-3.5 h-3.5' },
    lg: { container: 'mt-7 mb-10', logo: 'w-16 h-16 md:w-20 md:h-20', title: 'text-5xl', subtitle: 'text-base', icon: 'w-4 h-4' },
  };

  const variantClasses = {
    default: 'bg-gradient-to-r from-orange-500 via-red-500 to-rose-500 dark:from-orange-400 dark:via-red-400 dark:to-rose-500',
    ...
    <div className={`flex flex-col items-center ${currentSize.container} ${className}`}>
      <div className="flex items-center gap-3 sm:gap-4 group">
        ...
        <div className={`${currentSize.logo} relative flex-shrink-0`}>
          ...
          />
          <div className="absolute inset-0 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200
